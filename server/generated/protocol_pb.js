...
goog.exportSymbol('proto.BluePill', null, global);
 ...
 * @constructor
 */
proto.BluePill = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.BluePill, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.BluePill.displayName = 'proto.BluePill';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.Msg.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    bluepillmsg: (f = msg.getBluepillmsg()) && proto.BluePill.toObject(includeInstance, f)
  };
...
proto.Msg.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 16:
      ...
      break;
    case 19:
      var value = new proto.BluePill;
      reader.readMessage(value,proto.BluePill.deserializeBinaryFromReader);
      msg.setBluepillmsg(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.Msg.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getBluepillmsg();
  if (f != null) {
    writer.writeMessage(
      19,
      f,
      proto.BluePill.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.BluePill}
 */
proto.Msg.prototype.getBluepillmsg = function() {
  return /** @type{?proto.BluePill} */ (
    jspb.Message.getWrapperField(this, proto.BluePill, 19));
};


/**
 * @param {?proto.BluePill|undefined} value
 * @return {!proto.Msg} returns this
*/
proto.Msg.prototype.setBluepillmsg = function(value) {
 ...
 * @return {!proto.Msg} returns this
 */
proto.Msg.prototype.clearBluepillmsg = function() {
  return this.setBluepillmsg(undefined);
};
 ...
 * @return {boolean}
 */
proto.Msg.prototype.hasBluepillmsg = function() {
 ...
 * @return {!Object}
 */
proto.BluePill.prototype.toObject = function(opt_includeInstance) {
  return proto.BluePill.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.BluePill} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.BluePill.toObject = function(includeInstance, msg) {
  var f, obj = {
    content: msg.getContent_asB64()
  };
 ...
 * @return {!proto.BluePill}
 */
proto.BluePill.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.BluePill;
  return proto.BluePill.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.BluePill} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.BluePill}
 */
proto.BluePill.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.BluePill.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.BluePill.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.BluePill} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.BluePill.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!(string|Uint8Array)}
 */
proto.BluePill.prototype.getContent = function() {
 ...
 * @return {string}
 */
proto.BluePill.prototype.getContent_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getContent()));
};
 ...
 * @return {!Uint8Array}
 */
proto.BluePill.prototype.getContent_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getContent()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.BluePill} returns this
 */
proto.BluePill.prototype.setContent = function(value) {
  return jspb.Message.setField(this, 11, value);
};
 ...
 * @return {!proto.BluePill} returns this
 */
proto.BluePill.prototype.clearContent = function() {
  return jspb.Message.setField(this, 11, undefined);
};
 ...
 * @return {boolean}
 */
proto.BluePill.prototype.hasContent = function() {
  return jspb.Message.getField(this, 11) != null;
};
 ...
 * @return {?proto.BluePill}
 */
proto.MsgBack.prototype.getBluepillmsg = function() {
  return /** @type{?proto.BluePill} */ (
    jspb.Message.getWrapperField(this, proto.BluePill, 304));
};
 ...
 * @return {!proto.MsgBack} returns this
*/
proto.MsgBack.prototype.setBluepillmsg = function(value) {
 ...
 * @return {!proto.MsgBack} returns this
 */
proto.MsgBack.prototype.clearBluepillmsg = function() {
  return this.setBluepillmsg(undefined);
};
 ...
 * @return {boolean}
 */
proto.MsgBack.prototype.hasBluepillmsg = function() {
